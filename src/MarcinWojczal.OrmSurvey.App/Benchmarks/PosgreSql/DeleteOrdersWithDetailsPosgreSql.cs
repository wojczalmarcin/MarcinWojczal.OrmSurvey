...
{
    public class DeleteOrdersWithDetailsPosgreSql : BenchmarkBase
    {
        ...
        public void Dapper()
        {
            _dapperPostgreSql.DeleteOrdersWithDetails(_recordsToDelete);
        }

        [Benchmark]
        public void EntityFramework()
        {
            _efPostgreSql.DeleteOrdersWithDetails(_recordsToDeleteEf);
        }

        [Benchmark]
        public void NHibernate()
        {
            _nHibernatePostgreSql.DeleteOrdersWithDetails(_recordsToDeleteNhibernate);
        }
    }
}
